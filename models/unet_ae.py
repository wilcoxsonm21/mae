"""UNet-based standard autoencoder for 2D images."""
...
class UNetAE(BaseAutoencoder):
    """UNet-based autoencoder for 2D images.

    Designed for 32x32 images (like CIFAR-10/MNIST).
    Uses skip connections from encoder to decoder.
    """

    def __init__(self, input_dim, latent_dim, base_channels=64, dropout=0.0, image_size=32):
        """Initialize UNet autoencoder.
